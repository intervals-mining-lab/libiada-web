...
namespace LibiadaWeb.Helpers
{
    public static class PushNotificationHelper
    {
        ...
        /// Public VapidKey.
        /// </summary>
        const string publicKey = @"BHc-fO9M6yG_pZKFrZehXoNZNr6M6QGe48v6_nyoREJFij1kLIY_TVUzYnFqmFph2TPWjpF4fnCQmbJXRWdyFxU";

        /// <summary>
        /// Private VapidKey.
        /// </summary>
        const string privateKey = @"TJc2akKNUwEgdFz4jGzuhSkR1lq0uo8CWZlILlvv0As";
