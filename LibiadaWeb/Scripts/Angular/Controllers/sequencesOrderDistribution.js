function SequencesOrderDistributionController() {
    "use strict";

    function sequencesOrderDistribution($scope, $http) {
    ...
    angular.module("libiada", []).controller("SequencesOrderDistributionCtrl", ["$scope", "$http", sequencesOrderDistribution]);
}
