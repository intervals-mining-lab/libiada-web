 ...
 */
interface ResearchObjectCreateData {
    groups: Group[];
    languages: Language[];
 ...
 */
interface ResearchObjectCreateScope extends ng.IScope, ResearchObjectCreateData {
    nature: string;
    languageId: string;
    translatorId: string;
    trajectorId: string;
...
class ResearchObjectCreator {
    ...
    constructor(data: ResearchObjectCreateData) {
        this.ngOnInit(data);
    }

    private ngOnInit(data: ResearchObjectCreateData): void {
        const researchObjectCreate = ($scope: ResearchObjectCreateScope, filterFilter: ng.IFilterFilter): void => {
...
export default function ResearchObjectCreateController(data: ResearchObjectCreateData): ResearchObjectCreator {
