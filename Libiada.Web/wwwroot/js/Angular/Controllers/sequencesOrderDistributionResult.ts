...
class SequencesOrderDistributionResultHandler {
    ...
    private initializeController(): void {
        ...
        const sequencesOrderDistributionResult = ($scope: ISequencesOrderDistributionScope, $http: ng.IHttpService): void => {
            ...
            // Fetch data from API
            $http.get < ISequencesOrderDistributionData > (`/api/TaskManagerApi/GetTaskData/${$scope.taskId}`)
                .then(function (data) {
        ...
        angular.module("libiada").controller("SequencesOrderDistributionResultCtrl",
            ["$scope", "$http", sequencesOrderDistributionResult]);
    }
}
