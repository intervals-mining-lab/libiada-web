...
interface IPoint {
    ...
    // Свойства для intervalsCharacteristicsDistributionResult
    distributionIntervals?: IDistributionInterval[];
    order?: string;
    x?: number;
    y?: number;

    // Свойства для subsequencesCalculationResult
        ...
        const intervalsCharacteristicsDistributionResult = ($scope: IIntervalsCharacteristicsDistributionResultScope, $http: ng.IHttpService): void => {
            ...
            function draw(): void {
                ...
                svg.selectAll(".dot")
                    ...
                    .style("fill", (d: IPoint) => color(d.id))
                    .style("stroke", (d: IPoint) => color(d.id))
